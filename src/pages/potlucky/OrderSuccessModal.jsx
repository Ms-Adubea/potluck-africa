...
import { CheckCircle, Clock, CreditCard, AlertCircle, ArrowRight, Phone, X } from 'lucide-react';
          ...
          Swal.fire({
            ...
            html: `
              <div class="text-left">
                ...
                <p class="mb-2"><strong>Order ID:</strong> #${order._id?.slice(-8) || 'N/A'}</p>
        ...
        {isPaymentRequired ? (
          <div className="text-center">
            ...
            <p className="text-sm text-gray-500 mt-4">
              You can also complete payment later from your orders page
            </p>
          </div>
        ) : (
          <div className="text-center">
